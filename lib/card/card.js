...
var Card = _react3.default.createClass({
  displayName: 'Card',
  ...
  propTypes: {
     ...
     */
    actAsExpander: _react3.default.PropTypes.bool,
     ...
     */
    expandable: _react3.default.PropTypes.bool,

    /**
     * Whether this card is initially expanded.
     */
    initiallyExpanded: _react3.default.PropTypes.bool,

    /**
     * Fired when the expandable state changes.
     */
    onExpandChange: _react3.default.PropTypes.func,
     ...
     */
    showExpandableButton: _react3.default.PropTypes.bool,
  ...
  _onExpandable: function _onExpandable(event) {
    ...
    var newExpandedState = !(this.props.expand === true);
  ...
  render: function render() {
    ...
    var newChildren = _react3.default.Children.map(this.props.children, function (currentChild) {
      var doClone = false;
      ...
      if (_this.props.expanded === false && currentChild.props.expandable === true) return;
      ...
      if (currentChild.props.showExpandableButton === true) {
        doClone = true;
        newChild = _react3.default.createElement(_cardExpandable2.default, { expanded: _this.props.expanded, onExpanding: _this._onExpandable });
      }
      if (doClone) {
        element = _react3.default.cloneElement(currentChild, newProps, currentChild.props.children, newChild);
      }
      return element;
    }, this);
