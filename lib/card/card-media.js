...
function getStyles() {
  return {
    ...
    overlayContent: {
      ...
      left: 0,
      paddingTop: 8,
      background: _typography2.default.textLightBlack
    },
    media: {},
    mediaChild: {
      verticalAlign: 'top',
  ...
  render: function render() {
    ...
    var overlayChildren = _react2.default.Children.map(this.props.overlay, function (child) {
      if (child.type.displayName === 'CardHeader' || child.type.displayName === 'CardTitle') {
        return _react2.default.cloneElement(child, {
          titleColor: _typography2.default.textDarkWhite,
          subtitleColor: _typography2.default.textLightWhite
        });
      } else if (child.type.displayName === 'CardText') {
        return _react2.default.cloneElement(child, {
          color: _typography2.default.textDarkWhite
        });
      } else {
        return child;
      }
